...
# About
Open source ad/fakenews/gabling/porn-blocker for android

## Curated hosts sources
...
## Credits
This repo's hosts and all other data is based on stevenblack's repo. He takes ALL credits for all the scripts and stuff